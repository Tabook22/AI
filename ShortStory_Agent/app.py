#source:https://www.youtube.com/watch?v=vWukuS48RbY
...
#-----------------------------------------------------------------------------------------
#First we are going to creating 3 tools
#1- Tool to read the file
#2- Tool to generate the image
#3- Tool to convert to PDF
...
def generateimage(chapter_content_and_character_details: str) -> str:
    ...
    response = client.images.generate(
        #here we are using dall-e-3 to create the images
        model="dall-e-3",
    ...
    if image_response.status_code == 200:
        with open(filepath, 'wb') as file:
            #save the image in a file in the same folder
            file.write(image_response.content)
    else:
        print("Failed to download the image.")
        return ""
    #finally retrun the path to that image
    return filepath

#Here we adding another tool to convert the mark down file
@tool
...
#-----------------------------------------------------------------------------------------
#Second we are going to create the five agens , and asign five tasks to them
#1- Story_Outliner
#2- Writer
#3- Image_Creator
#4- Content_Formatter
...
# Create tasks for the agents (define the task for each agent)
task_outline = Task(
...
task_format_content = Task(
    ...
    #taks the full story from the task_writer and the images and merge them togather
...
#-----------------------------------------------------------------------------------------
#Third step or final step making the five agents working togather
